<template>
  <div id="home">
    ...
    <div id="start-shopping" class="container">
      ...
      <div class="row">
        <div v-for="index in this.category_size" :key="index" class="col-md-6 col-xl-4 col-12 pt-3  justify-content-around d-flex custom" >
    ...
    <div class="container">
      ...
      <div class="row">
        <div v-for="index in this.product_size" :key="index" class="col-md-6 col-xl-4 col-12 pt-3  justify-content-around d-flex custom">
